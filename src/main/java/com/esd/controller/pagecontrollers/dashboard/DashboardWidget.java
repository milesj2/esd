...
public class DashboardWidget {
    ...
    public static DashboardWidget APPOINTMENT_SEARCH_WIDGET = new DashboardWidget("Appointments Search", "appointments/search", "res/icons/appointment-search.png");
    public static DashboardWidget APPOINTMENT_SCHEDULE_WIDGET = new DashboardWidget("Appointments Schedule", "appointments/schedule", "res/icons/calendar.png");
