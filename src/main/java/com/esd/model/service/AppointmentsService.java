...
public class AppointmentsService {
    ...
    public List<Appointment> getAllAppointments(LocalDate fromDate, LocalDate toDate) throws SQLException {
        return appointmentDao.getAllAppointments(fromDate, toDate);
    }
