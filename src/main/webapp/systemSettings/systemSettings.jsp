...
<head>
    ...
    <body>
        <form method="post" action="${pageContext.request.contextPath}/systemSettings">
            ...
            <label>Current: <%=request.getAttribute(DaoConsts.SYSTEMSETTING_FEE_DOCTOR)%></label>
            <br>
            ...
            <label>Current: <%=request.getAttribute(DaoConsts.SYSTEMSETTING_FEE_NURSE)%></label>
            <br>
            ...
            <label>Current: <%=request.getAttribute(DaoConsts.SYSTEMSETTING_SLOT_TIME)%></label>
            <br>
